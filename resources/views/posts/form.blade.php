...
<div class="panel panel-default">
  ...
  <div class="form-group">
    ...
    <input name="titulo" value="{{old('titulo')}}" type="text" class="form-control" id="exampleInputEmail1" placeholder="Titulo" required="required">
<br>
...
@endif
  ...
  <div class="form-group">
   ...
   <input name="texto" value="{{old('texto')}}" class="form-control" id="exampleInputEmail1" placeholder="contenido" required="required">
   <br>
   @if ($errors->has('texto'))
 <div class="alert alert-danger animated bounceIn">
 <span class="help-block">
